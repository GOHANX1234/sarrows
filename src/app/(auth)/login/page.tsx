...
import { CheckCircle2, Film, Tv2, Star, Shield } from "lucide-react";
import LogoMark from "@/components/ui/LogoMark";

export const metadata = { title: "Sign In — Sarrows" };
    ...
    <div className="min-h-screen bg-sarrows-darker flex">
        ...
        <div className="relative z-10 space-y-8">
          <div>
            ...
            <p className="text-gray-400 text-lg leading-relaxed max-w-sm">
              One home for the films and series you love — and the next ones you haven't found yet.
            </p>
          </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-5 sm:px-10 py-12 relative overflow-hidden">
        ...
        <div className="w-full max-w-[400px] animate-fade-in">
          ...
          {/* Heading */}
          <div className="mb-7">
            <h1 className="text-2xl sm:text-3xl font-black text-white mb-1.5 tracking-tight">Welcome back</h1>
            <p className="text-gray-500 text-sm">Sign in to continue watching</p>
          </div>

          {/* Success banner */}
          {registered === "1" && (
            <div className="mb-5 rounded-xl px-4 py-3 text-sm font-medium flex items-center gap-2"
          ...
          <p className="text-center text-gray-600 text-sm mt-5">
            ...
            <Link href="/signup" className="text-sarrows-red hover:text-red-400 font-semibold transition">
              Sign up free
            </Link>
          </p>
        </div>
