  ...
  return (
    <div className="min-h-screen bg-sarrows-darker">
      ...
      <div className="glass-navbar px-4 md:px-8 h-12 flex items-center justify-between">
        <Link href={`/${series.type === "series" ? "series" : "anime"}/${series.slug}`} className="flex items-center gap-2 text-gray-400 hover:text-white text-sm transition">
        ...
        <Link href={`/${series.type === "series" ? "series" : "anime"}/${series.slug}`} className="flex items-center gap-1.5 text-xs text-gray-500 hover:text-white transition glass px-3 py-1.5 rounded-lg">
      ...
      <div className="max-w-5xl mx-auto px-4 md:px-8 py-6">
        ...
        <div className="flex items-center justify-between mt-4 gap-3">
          {prevEpisode ? (
            <Link
              href={`/${series.type === "series" ? "series" : "anime"}/${series.slug}/episode/${prevEpisode._id}`}
          ...
          {nextEpisode && (
            <Link
              href={`/${series.type === "series" ? "series" : "anime"}/${series.slug}/episode/${nextEpisode._id}`}
