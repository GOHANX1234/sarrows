...
const SOURCE_PATH: Record<BotDiscoverySource, SourceConfig> = {
  popular:           { path: "/movie/popular" },
  trending_day:      { path: "/trending/movie/day" },
  trending_week:     { path: "/trending/movie/week" },
  top_rated:         { path: "/movie/top_rated" },
  now_playing:       { path: "/movie/now_playing" },
  upcoming:          { path: "/movie/upcoming" },
  // Genre-based discovery via TMDB /discover/movie
  genre_action:      { path: "/discover/movie", params: { with_genres: "28",    sort_by: "popularity.desc" } },
  genre_horror:      { path: "/discover/movie", params: { with_genres: "27",    sort_by: "popularity.desc" } },
  genre_comedy:      { path: "/discover/movie", params: { with_genres: "35",    sort_by: "popularity.desc" } },
  genre_thriller:    { path: "/discover/movie", params: { with_genres: "53",    sort_by: "popularity.desc" } },
  genre_scifi:       { path: "/discover/movie", params: { with_genres: "878",   sort_by: "popularity.desc" } },
  genre_animation:   { path: "/discover/movie", params: { with_genres: "16",    sort_by: "popularity.desc" } },
  genre_drama:       { path: "/discover/movie", params: { with_genres: "18",    sort_by: "popularity.desc" } },
  genre_romance:     { path: "/discover/movie", params: { with_genres: "10749", sort_by: "popularity.desc" } },
  genre_crime:       { path: "/discover/movie", params: { with_genres: "80",    sort_by: "popularity.desc" } },
  genre_documentary: { path: "/discover/movie", params: { with_genres: "99",    sort_by: "popularity.desc" } },
  genre_adventure:   { path: "/discover/movie", params: { with_genres: "12",    sort_by: "popularity.desc" } },
  genre_fantasy:     { path: "/discover/movie", params: { with_genres: "14",    sort_by: "popularity.desc" } },
  genre_mystery:     { path: "/discover/movie", params: { with_genres: "9648",  sort_by: "popularity.desc" } },
  genre_war:         { path: "/discover/movie", params: { with_genres: "10752", sort_by: "popularity.desc" } },
};
...
export async function fetchTMDBDiscoveryPage(
  ...
  const cfg = SOURCE_PATH[source] ?? SOURCE_PATH.popular;
  const data = await tmdbFetch<{ results: TMDBMovie[]; total_pages: number }>(
    cfg.path,
    { page: String(page), ...(cfg.params ?? {}) }
  );
